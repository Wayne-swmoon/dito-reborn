...
export function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "일정한 수입이 있고, 총 채무액이 무담보 채무 10억원 이하, 담보부 채무 15억원 이하인 경우 신청 가능합니다. 급여 소득자, 자영업자, 프리랜서 모두 신청할 수 있습니다."
    },
    {
      question: "개인회생 비용은 얼마나 드나요?",
      answer: "초기 상담은 무료이며, 법원 비용과 변호사 수임료가 발생합니다. 저희는 초기 비용 일시불 납부 부담을 최소화했으며, 분할 납부도 가능합니다. 정확한 비용은 상담 시 안내드립니다."
    },
    {
      question: "출장 상담도 가능하나요?",
      answer: "네, 출장 상담 서비스 가능합니다. 하지만, 출장 상담의 경우 방문 상담과 달리 소정의 출장비용이 발생합니다. 비용은 전화 상담 시 안내드립니다."
    },
    {
