  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 lg:hidden p-4 pb-[max(1rem,env(safe-area-inset-bottom))] pointer-events-none">
      ...
      <div className="flex gap-2 pointer-events-auto">
        {/* [왼쪽 버튼] 전화상담: 다급한 심리를 자극하는 강렬한 오렌지색 적용 */}
        <a
          href="tel:070-8064-6525"
          className="flex-1 flex items-center justify-center gap-2 bg-[#FF6B00] text-white py-4 rounded-2xl font-black text-base shadow-xl active:scale-95 transition-transform"
        >
          <Phone className="w-5 h-5 text-white" />
          전화상담
        </a>
        
        {/* [오른쪽 버튼] 무료상담 신청: 시선을 끄는 카카오 노란색 적용 */}
        <a
          href="#contact"
